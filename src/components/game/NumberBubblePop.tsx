  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="relative h-96 max-w-full overflow-hidden bg-gradient-to-br from-cyan-100 to-blue-200 rounded-2xl shadow-lg mb-8">
          {gameActive && (
            <div className="relative w-full h-full">
              {bubbles.map((bubble) => (
                <button
                  ...
                  className={`absolute w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16  ${bubble.color} rounded-full flex items-center justify-center font-fredoka font-bold text-white text-xl shadow-lg transform transition-all duration-300 hover:scale-110 z-10 ${bubble.popped ? 'opacity-30 scale-50 pointer-events-none' : 'animate-pulse hover:animate-none'
                    }`}
                  style={{
                    left: `${bubble.x}%`,
                    top: `${bubble.y}%`,
          ...
          {!gameActive && !gameCompleted && (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center animate-fade-in">
                ...
                <div className="font-comic text-gray-600 mb-4">Click the numbers in order from smallest to largest!</div>
                <Button
                  onClick={startGame}
        ...
        <Card className="p-6 bg-white rounded-2xl shadow-lg">
          ...
          <div className="mt-8 py-6 bg-gradient-to-r from-yellow-100 to-orange-100 border border-orange-300 rounded-2xl">
