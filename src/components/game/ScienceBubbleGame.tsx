...
import { Star, Clock, Zap, Target, Trophy, Heart, Atom } from 'lucide-react';
...
const ScienceBubbleGame = () => {
  ...
  const scienceQuestions = {
    easy: [
      ...
      { q: 'How many legs does a spider have?', correct: '8', wrong: ['6', '10', '4'] },
    ...
    medium: [
      ...
      { q: 'What organ pumps blood?', correct: 'Heart', wrong: ['Liver', 'Kidney', 'Lungs'] }
    ],
    hard: [
