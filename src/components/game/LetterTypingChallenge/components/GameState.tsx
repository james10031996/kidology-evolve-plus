...
import { Clock, Heart, Keyboard } from 'lucide-react';
        ...
        <div className="flex justify-between items-center mb-4 bg-white/80 backdrop-blur-sm rounded-xl p-4">
          <div className="flex items-center space-x-6">
            <div className="text-center">
              ...
              <div className="font-bold text-lg text-emerald-600 capitalize">{gameStats.mode}</div>
            </div>
            <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="font-comic text-lg text-gray-600">
              {isSpeedRound ? '⚡ SPEED TYPING! ⚡' : 'Type 5 words starting with this letter!'}
            </div>
            <div className="mt-2 text-sm text-gray-500 font-comic flex items-center justify-center">
              <Keyboard className="w-4 h-4 mr-1" />
              Look for items with yellow rings!
            </div>
          </div>
