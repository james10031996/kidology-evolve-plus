...
import { ArrowLeft, Apple, Heart, Zap } from 'lucide-react';
...
const HealthNutrition = () => {
  ...
  const lessons = [
    {
      ...
      description: 'Learn about nutritious foods that make you strong',
    ...
    },
    {
      id: 'exercise-fun',
      title: '💪 Exercise & Fun',
      description: 'Discover fun ways to stay active and healthy',
      icon: <Zap className="w-8 h-8" />,
      color: 'gradient-orange'
    },
    {
      id: 'body-care',
      title: '❤️ Taking Care of Yourself',
      description: 'Learn how to keep your body and mind healthy',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-orange-50 to-pink-50">
      <Header />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="font-fredoka font-bold text-5xl bg-gradient-to-r from-green-600 via-orange-600 to-pink-600 bg-clip-text text-transparent mb-4">
            🍎 Health & Nutrition
          </h1>
          <p className="font-comic text-xl text-gray-700">
            Discover how to stay healthy, strong, and happy! 💪✨
          </p>
        </div>
          ...
          {lessons.map((lesson, index) => (
            <Card key={lesson.id} className="p-8 bg-white rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in border-4 border-transparent hover:border-green-200" style={{ animationDelay: `${index * 0.1}s` }}>
              <div className={`w-full h-32 ${lesson.color} rounded-2xl mb-6 flex items-center justify-center relative overflow-hidden`}>
                <div className="text-white z-10 animate-pulse">
                  {lesson.icon}
                </div>
